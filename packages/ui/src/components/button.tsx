    ...
    return (
      <Comp
        className={cn(
          ...
          className,
          isLoading
            ? 'after:content-[""] after:absolute after:top-1/2 after:right-3 after:h-4 after:w-4 after:-translate-y-1/2 after:rounded-full after:border-2 after:border-current after:border-t-transparent after:animate-spin'
            : "",
        )}
        ref={ref}
